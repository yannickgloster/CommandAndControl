...
public abstract class PacketContent {
	...
	public static final int WORKERPACKET = 3;
	public static final int COMMANDPACKET = 4;
	public static final int BROKERPACKET = 5;
	...
	public static PacketContent fromDatagramPacket(DatagramPacket packet) {
		...
		try {
			...
			case FILEINFO:
				...
				break;
			case WORKERPACKET:
				content= new WorkerPacket(oin);
				break;
			case COMMANDPACKET:
				content= new CommandPacket(oin);
				break;
			case BROKERPACKET:
				content= new BrokerPacket(oin);
				break;
			default:
				content= null;
				break;
